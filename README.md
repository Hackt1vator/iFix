# iFix
<h1 align="center">
    <p>mdm bypass for ios 12-16 on Linux for non wiped devices</p>
...
<h3 align"center">Now cd the device folder inside the iFix folder and run the last command again
